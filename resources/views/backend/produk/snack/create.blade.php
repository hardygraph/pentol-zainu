        ...
        <div class="allcp-form">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('snack.store') }}" id="form-ui" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section">
                                    <label class="field">
                                        <input type="text" name="snack" id="snack" class="gui-input @error('snack') is-invalid @enderror" value="{{ old('snack') }}"
                                               placeholder="Isi Jenis snack..">
                                    </label>
                                    @error('snack')
