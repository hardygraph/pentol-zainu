        ...
        <div class="allcp-form">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('pentol.store') }}" id="form-ui" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section">
                                    <label class="field">
                                        <input type="text" name="pentol" id="pentol" class="gui-input @error('pentol') is-invalid @enderror" value="{{ old('pentol') }}"
                                               placeholder="Isi Jenis Pentol..">
                                    </label>
                                    @error('pentol')
